...
class IWebTest(object):
    ...
    def setup_class(cls):
        ...
        cls.itest = lib.ITest()
        cls.itest.setup_method(None)
        cls.client = cls.itest.client
        cls.django_clients = []
        exp, omeName = cls.itest.user_and_name(cls.itest.client)
        cls.django_client = cls.new_django_client(omeName, omeName)
        rootpass = cls.itest.root.ic.getProperties().getProperty('omero.rootpass')
    ...
    def teardown_class(cls):
        ...
        cls.itest.teardown_method(None)
    ...
    def import_image(self, *args, **kwargs):
        return self.itest.import_image(*args, **kwargs)
