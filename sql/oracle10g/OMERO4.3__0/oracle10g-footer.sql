...
CREATE OR REPLACE PROCEDURE prepare_session(event_id_in IN NUMBER,
                                           user_id_in  IN NUMBER,
                                           group_id_in IN NUMBER)
IS
BEGIN
    DELETE FROM current_session;
    INSERT INTO current_session VALUES (event_id_in, user_id_in, group_id_in);
END prepare_session;
/
...
BEGIN
    ...
    THEN
        ...
        INSERT INTO event (id, permissions, status, time, experimenter,
            ...
            VALUES (eid, -35, 'TRIGGERED', SYSDATE, 0, 0, 0, 0);
    END IF;
    RETURN eid;
...
BEGIN
    ...
    INSERT INTO eventlog (id, action, permissions, entityid, entitytype, event)
        VALUES (nextval, 'REINDEX', -35, :NEW.parent, 'ome.model.containers.Dataset', eid);
END linkEvt_dataset;
/
...
BEGIN
    ...
    nextval := ome_nextval('seq_eventlog');
    INSERT INTO eventlog (id, action, permissions, entityid, entitytype, event)
        VALUES (nextval, 'REINDEX', -35, :NEW.parent, 'ome.model.screen.Plate', eid);
END linkEvt_plate;
/
...
BEGIN
    ...
    nextval := ome_nextval('seq_eventlog');
    INSERT INTO eventlog (id, action, permissions, entityid, entitytype, event)
        VALUES (nextval, 'REINDEX', -35, :NEW.parent, 'ome.model.core.Channel', eid);
END linkEvt_channel;
/
...
BEGIN
    ...
    nextval := ome_nextval('seq_eventlog');
    INSERT INTO eventlog (id, action, permissions, entityid, entitytype, event)
        VALUES (nextval, 'REINDEX', -35, :NEW.parent, 'ome.model.screen.WellSample', eid);
...
BEGIN
    ...
    nextval := ome_nextval('seq_eventlog');
    INSERT INTO eventlog (id, action, permissions, entityid, entitytype, event)
        VALUES (nextval, 'REINDEX', -35, :NEW.parent, 'ome.model.core.PlaneInfo', eid);
...
BEGIN
    ...
    nextval := ome_nextval('seq_eventlog');
    INSERT INTO eventlog (id, action, permissions, entityid, entitytype, event)
        VALUES (nextval, 'REINDEX', -35, :NEW.parent, 'ome.model.meta.Namespace', eid);
...
BEGIN
    ...
    nextval := ome_nextval('seq_eventlog');
    INSERT INTO eventlog (id, action, permissions, entityid, entitytype, event)
        VALUES (nextval, 'REINDEX', -35, :NEW.parent, 'ome.model.core.Image', eid);
END linkEvt_image;
/
CREATE OR REPLACE TRIGGER linkEvt_group
AFTER UPDATE ON experimentergroupannotation3
FOR EACH ROW
DECLARE
    eid NUMBER;
    nextval NUMBER;
BEGIN
    ...
    nextval := ome_nextval('seq_eventlog');
    INSERT INTO eventlog (id, action, permissions, entityid, entitytype, event)
        VALUES (nextval, 'REINDEX', -35, :NEW.parent, 'ome.model.meta.ExperimenterGroup', eid);
END linkEvt_group;
/
...
BEGIN
    ...
    nextval := ome_nextval('seq_eventlog');
    INSERT INTO eventlog (id, action, permissions, entityid, entitytype, event)
        VALUES (nextval, 'REINDEX', -35, :NEW.parent, 'ome.model.containers.Project', eid);
END linkEvt_project;
/
...
BEGIN
    ...
    nextval := ome_nextval('seq_eventlog');
    INSERT INTO eventlog (id, action, permissions, entityid, entitytype, event)
        VALUES (nextval, 'REINDEX', -35, :NEW.parent, 'ome.model.core.Pixels', eid);
END linkEvt_pixels;
/
...
BEGIN
    ...
    nextval := ome_nextval('seq_eventlog');
    INSERT INTO eventlog (id, action, permissions, entityid, entitytype, event)
        VALUES (nextval, 'REINDEX', -35, :NEW.parent, 'ome.model.roi.Roi', eid);
END linkEvt_roi;
/
...
BEGIN
    ...
    nextval := ome_nextval('seq_eventlog');
    INSERT INTO eventlog (id, action, permissions, entityid, entitytype, event)
        VALUES (nextval, 'REINDEX', -35, :NEW.parent, 'ome.model.screen.Well', eid);
END linkEvt_well;
/
...
BEGIN
    ...
    nextval := ome_nextval('seq_eventlog');
    INSERT INTO eventlog (id, action, permissions, entityid, entitytype, event)
        VALUES (nextval, 'REINDEX', -35, :NEW.parent, 'ome.model.screen.Reagent', eid);
END linkEvt_reagent;
/
...
BEGIN
    ...
    nextval := ome_nextval('seq_eventlog');
    INSERT INTO eventlog (id, action, permissions, entityid, entitytype, event)
        VALUES (nextval, 'REINDEX', -35, :NEW.parent, 'ome.model.core.OriginalFile', eid);
...
BEGIN
    ...
    nextval := ome_nextval('seq_eventlog');
    INSERT INTO eventlog (id, action, permissions, entityid, entitytype, event)
        VALUES (nextval, 'REINDEX', -35, :NEW.parent, 'ome.model.annotations.Annotation', eid);
END linkEvt_ann;
/
...
BEGIN
    ...
    nextval := ome_nextval('seq_eventlog');
    INSERT INTO eventlog (id, action, permissions, entityid, entitytype, event)
        VALUES (nextval, 'REINDEX', -35, :NEW.parent, 'ome.model.screen.Screen', eid);
END linkEvt_screen;
/
...
BEGIN
    ...
    nextval := ome_nextval('seq_eventlog');
    INSERT INTO eventlog (id, action, permissions, entityid, entitytype, event)
        VALUES (nextval, 'REINDEX', -35, :NEW.parent, 'ome.model.meta.Session', eid);
...
BEGIN
    ...
    nextval := ome_nextval('seq_eventlog');
    INSERT INTO eventlog (id, action, permissions, entityid, entitytype, event)
        VALUES (nextval, 'REINDEX', -35, :NEW.parent, 'ome.model.screen.PlateAcquisition', eid);
...
BEGIN
    ...
    nextval := ome_nextval('seq_eventlog');
    INSERT INTO eventlog (id, action, permissions, entityid, entitytype, event)
        VALUES (nextval, 'REINDEX', -35, :NEW.parent, 'ome.model.meta.Node', eid);
END linkEvt_node;
/
...
BEGIN
    ...
    nextval := ome_nextval('seq_eventlog');
    INSERT INTO eventlog (id, action, permissions, entityid, entitytype, event)
        VALUES (nextval, 'REINDEX', -35, :NEW.parent, 'ome.model.meta.Experimenter', eid);
...
--
alter table dbpatch modify permissions default -35;
...
insert into node
        ...
        select 0,-35,'000000000000000000000000000000000000','unknown',SYSDATE,SYSDATE FROM dual;
insert into session_
        (id,permissions,timetoidle,timetolive,started,closed,defaulteventtype,uuid,owner,node)
        select 0,-35,0,0,SYSDATE,SYSDATE,'BOOTSTRAP',0000,0,0 FROM dual;
insert into session_
        (id,permissions,timetoidle,timetolive,started,closed,defaulteventtype,uuid,owner,node)
        select ome_nextval('seq_session'),-35,0,0,SYSDATE,SYSDATE,'PREVIOUSITEMS','1111',0,0 FROM dual;
...
insert into experimentergroup (id,permissions,version,name)
        select ome_nextval('seq_experimentergroup'),-35,0,'user' from dual;
insert into experimentergroup (id,permissions,version,name)
        select ome_nextval('seq_experimentergroup'),-103,0,'guest' from dual;
...
insert into groupexperimentermap
        (id,permissions,version, parent, child, child_index,owner)
        select ome_nextval('seq_groupexperimentermap'),-35,0,1,0,1,0 from dual;
insert into groupexperimentermap
        (id,permissions,version, parent, child, child_index,owner)
        select ome_nextval('seq_groupexperimentermap'),-35,0,2,1,0,0 from dual;
...
insert into filtertype (id,permissions,value)
    select ome_nextval('seq_filtertype'),-35,'LongPass' from dual;
insert into filtertype (id,permissions,value)
    select ome_nextval('seq_filtertype'),-35,'ShortPass' from dual;
insert into filtertype (id,permissions,value)
    select ome_nextval('seq_filtertype'),-35,'BandPass' from dual;
insert into filtertype (id,permissions,value)
    select ome_nextval('seq_filtertype'),-35,'MultiPass' from dual;
insert into filtertype (id,permissions,value)
    select ome_nextval('seq_filtertype'),-35,'Dichroic' from dual;
insert into filtertype (id,permissions,value)
    select ome_nextval('seq_filtertype'),-35,'NeutralDensity' from dual;
insert into filtertype (id,permissions,value)
    select ome_nextval('seq_filtertype'),-35,'Other' from dual;
insert into filtertype (id,permissions,value)
    select ome_nextval('seq_filtertype'),-35,'Unknown' from dual;
insert into immersion (id,permissions,value)
    select ome_nextval('seq_immersion'),-35,'Oil' from dual;
insert into immersion (id,permissions,value)
    select ome_nextval('seq_immersion'),-35,'Water' from dual;
insert into immersion (id,permissions,value)
    select ome_nextval('seq_immersion'),-35,'WaterDipping' from dual;
insert into immersion (id,permissions,value)
    select ome_nextval('seq_immersion'),-35,'Air' from dual;
insert into immersion (id,permissions,value)
    select ome_nextval('seq_immersion'),-35,'Multi' from dual;
insert into immersion (id,permissions,value)
    select ome_nextval('seq_immersion'),-35,'Glycerol' from dual;
insert into immersion (id,permissions,value)
    select ome_nextval('seq_immersion'),-35,'Other' from dual;
insert into immersion (id,permissions,value)
    select ome_nextval('seq_immersion'),-35,'Unknown' from dual;
insert into arctype (id,permissions,value)
    select ome_nextval('seq_arctype'),-35,'Hg' from dual;
insert into arctype (id,permissions,value)
    select ome_nextval('seq_arctype'),-35,'Xe' from dual;
insert into arctype (id,permissions,value)
    select ome_nextval('seq_arctype'),-35,'HgXe' from dual;
insert into arctype (id,permissions,value)
    select ome_nextval('seq_arctype'),-35,'Other' from dual;
insert into arctype (id,permissions,value)
    select ome_nextval('seq_arctype'),-35,'Unknown' from dual;
insert into experimenttype (id,permissions,value)
    select ome_nextval('seq_experimenttype'),-35,'FP' from dual;
insert into experimenttype (id,permissions,value)
    select ome_nextval('seq_experimenttype'),-35,'FRET' from dual;
insert into experimenttype (id,permissions,value)
    select ome_nextval('seq_experimenttype'),-35,'TimeLapse' from dual;
insert into experimenttype (id,permissions,value)
    select ome_nextval('seq_experimenttype'),-35,'FourDPlus' from dual;
insert into experimenttype (id,permissions,value)
    select ome_nextval('seq_experimenttype'),-35,'Screen' from dual;
insert into experimenttype (id,permissions,value)
    select ome_nextval('seq_experimenttype'),-35,'Immunocytochemistry' from dual;
insert into experimenttype (id,permissions,value)
    select ome_nextval('seq_experimenttype'),-35,'Immunofluorescence' from dual;
insert into experimenttype (id,permissions,value)
    select ome_nextval('seq_experimenttype'),-35,'FISH' from dual;
insert into experimenttype (id,permissions,value)
    select ome_nextval('seq_experimenttype'),-35,'Electrophysiology' from dual;
insert into experimenttype (id,permissions,value)
    select ome_nextval('seq_experimenttype'),-35,'IonImaging' from dual;
insert into experimenttype (id,permissions,value)
    select ome_nextval('seq_experimenttype'),-35,'Colocalization' from dual;
insert into experimenttype (id,permissions,value)
    select ome_nextval('seq_experimenttype'),-35,'PGIDocumentation' from dual;
insert into experimenttype (id,permissions,value)
    select ome_nextval('seq_experimenttype'),-35,'FluorescenceLifetime' from dual;
insert into experimenttype (id,permissions,value)
    select ome_nextval('seq_experimenttype'),-35,'SpectralImaging' from dual;
insert into experimenttype (id,permissions,value)
    select ome_nextval('seq_experimenttype'),-35,'Photobleaching' from dual;
insert into experimenttype (id,permissions,value)
    select ome_nextval('seq_experimenttype'),-35,'Other' from dual;
insert into experimenttype (id,permissions,value)
    select ome_nextval('seq_experimenttype'),-35,'Unknown' from dual;
insert into renderingmodel (id,permissions,value)
    select ome_nextval('seq_renderingmodel'),-35,'rgb' from dual;
insert into renderingmodel (id,permissions,value)
    select ome_nextval('seq_renderingmodel'),-35,'greyscale' from dual;
insert into eventtype (id,permissions,value)
    select ome_nextval('seq_eventtype'),-35,'Import' from dual;
insert into eventtype (id,permissions,value)
    select ome_nextval('seq_eventtype'),-35,'Internal' from dual;
insert into eventtype (id,permissions,value)
    select ome_nextval('seq_eventtype'),-35,'Shoola' from dual;
insert into eventtype (id,permissions,value)
    select ome_nextval('seq_eventtype'),-35,'User' from dual;
insert into eventtype (id,permissions,value)
    select ome_nextval('seq_eventtype'),-35,'Task' from dual;
insert into eventtype (id,permissions,value)
    select ome_nextval('seq_eventtype'),-35,'Test' from dual;
insert into eventtype (id,permissions,value)
    select ome_nextval('seq_eventtype'),-35,'Processing' from dual;
insert into eventtype (id,permissions,value)
    select ome_nextval('seq_eventtype'),-35,'FullText' from dual;
insert into eventtype (id,permissions,value)
    select ome_nextval('seq_eventtype'),-35,'Sessions' from dual;
insert into microscopetype (id,permissions,value)
    select ome_nextval('seq_microscopetype'),-35,'Upright' from dual;
insert into microscopetype (id,permissions,value)
    select ome_nextval('seq_microscopetype'),-35,'Inverted' from dual;
insert into microscopetype (id,permissions,value)
    select ome_nextval('seq_microscopetype'),-35,'Dissection' from dual;
insert into microscopetype (id,permissions,value)
    select ome_nextval('seq_microscopetype'),-35,'Electrophysiology' from dual;
insert into microscopetype (id,permissions,value)
    select ome_nextval('seq_microscopetype'),-35,'Other' from dual;
insert into microscopetype (id,permissions,value)
    select ome_nextval('seq_microscopetype'),-35,'Unknown' from dual;
insert into filamenttype (id,permissions,value)
    select ome_nextval('seq_filamenttype'),-35,'Incandescent' from dual;
insert into filamenttype (id,permissions,value)
    select ome_nextval('seq_filamenttype'),-35,'Halogen' from dual;
insert into filamenttype (id,permissions,value)
    select ome_nextval('seq_filamenttype'),-35,'Other' from dual;
insert into filamenttype (id,permissions,value)
    select ome_nextval('seq_filamenttype'),-35,'Unknown' from dual;
insert into photometricinterpretation (id,permissions,value)
    select ome_nextval('seq_photometricinterpretation'),-35,'RGB' from dual;
insert into photometricinterpretation (id,permissions,value)
    select ome_nextval('seq_photometricinterpretation'),-35,'ARGB' from dual;
insert into photometricinterpretation (id,permissions,value)
    select ome_nextval('seq_photometricinterpretation'),-35,'CMYK' from dual;
insert into photometricinterpretation (id,permissions,value)
    select ome_nextval('seq_photometricinterpretation'),-35,'HSV' from dual;
insert into photometricinterpretation (id,permissions,value)
    select ome_nextval('seq_photometricinterpretation'),-35,'Monochrome' from dual;
insert into photometricinterpretation (id,permissions,value)
    select ome_nextval('seq_photometricinterpretation'),-35,'ColorMap' from dual;
insert into lasertype (id,permissions,value)
    select ome_nextval('seq_lasertype'),-35,'Excimer' from dual;
insert into lasertype (id,permissions,value)
    select ome_nextval('seq_lasertype'),-35,'Gas' from dual;
insert into lasertype (id,permissions,value)
    select ome_nextval('seq_lasertype'),-35,'MetalVapor' from dual;
insert into lasertype (id,permissions,value)
    select ome_nextval('seq_lasertype'),-35,'SolidState' from dual;
insert into lasertype (id,permissions,value)
    select ome_nextval('seq_lasertype'),-35,'Dye' from dual;
insert into lasertype (id,permissions,value)
    select ome_nextval('seq_lasertype'),-35,'Semiconductor' from dual;
insert into lasertype (id,permissions,value)
    select ome_nextval('seq_lasertype'),-35,'FreeElectron' from dual;
insert into lasertype (id,permissions,value)
    select ome_nextval('seq_lasertype'),-35,'Other' from dual;
insert into lasertype (id,permissions,value)
    select ome_nextval('seq_lasertype'),-35,'Unknown' from dual;
insert into dimensionorder (id,permissions,value)
    select ome_nextval('seq_dimensionorder'),-35,'XYZCT' from dual;
insert into dimensionorder (id,permissions,value)
    select ome_nextval('seq_dimensionorder'),-35,'XYZTC' from dual;
insert into dimensionorder (id,permissions,value)
    select ome_nextval('seq_dimensionorder'),-35,'XYCTZ' from dual;
insert into dimensionorder (id,permissions,value)
    select ome_nextval('seq_dimensionorder'),-35,'XYCZT' from dual;
insert into dimensionorder (id,permissions,value)
    select ome_nextval('seq_dimensionorder'),-35,'XYTCZ' from dual;
insert into dimensionorder (id,permissions,value)
    select ome_nextval('seq_dimensionorder'),-35,'XYTZC' from dual;
insert into binning (id,permissions,value)
    select ome_nextval('seq_binning'),-35,'1x1' from dual;
insert into binning (id,permissions,value)
    select ome_nextval('seq_binning'),-35,'2x2' from dual;
insert into binning (id,permissions,value)
    select ome_nextval('seq_binning'),-35,'4x4' from dual;
insert into binning (id,permissions,value)
    select ome_nextval('seq_binning'),-35,'8x8' from dual;
insert into family (id,permissions,value)
    select ome_nextval('seq_family'),-35,'linear' from dual;
insert into family (id,permissions,value)
    select ome_nextval('seq_family'),-35,'polynomial' from dual;
insert into family (id,permissions,value)
    select ome_nextval('seq_family'),-35,'exponential' from dual;
insert into family (id,permissions,value)
    select ome_nextval('seq_family'),-35,'logarithmic' from dual;
insert into illumination (id,permissions,value)
    select ome_nextval('seq_illumination'),-35,'Transmitted' from dual;
insert into illumination (id,permissions,value)
    select ome_nextval('seq_illumination'),-35,'Epifluorescence' from dual;
insert into illumination (id,permissions,value)
    select ome_nextval('seq_illumination'),-35,'Oblique' from dual;
insert into illumination (id,permissions,value)
    select ome_nextval('seq_illumination'),-35,'NonLinear' from dual;
insert into illumination (id,permissions,value)
    select ome_nextval('seq_illumination'),-35,'Other' from dual;
insert into illumination (id,permissions,value)
    select ome_nextval('seq_illumination'),-35,'Unknown' from dual;
insert into detectortype (id,permissions,value)
    select ome_nextval('seq_detectortype'),-35,'CCD' from dual;
insert into detectortype (id,permissions,value)
    select ome_nextval('seq_detectortype'),-35,'IntensifiedCCD' from dual;
insert into detectortype (id,permissions,value)
    select ome_nextval('seq_detectortype'),-35,'AnalogVideo' from dual;
insert into detectortype (id,permissions,value)
    select ome_nextval('seq_detectortype'),-35,'PMT' from dual;
insert into detectortype (id,permissions,value)
    select ome_nextval('seq_detectortype'),-35,'Photodiode' from dual;
insert into detectortype (id,permissions,value)
    select ome_nextval('seq_detectortype'),-35,'Spectroscopy' from dual;
insert into detectortype (id,permissions,value)
    select ome_nextval('seq_detectortype'),-35,'LifetimeImaging' from dual;
insert into detectortype (id,permissions,value)
    select ome_nextval('seq_detectortype'),-35,'CorrelationSpectroscopy' from dual;
insert into detectortype (id,permissions,value)
    select ome_nextval('seq_detectortype'),-35,'FTIR' from dual;
insert into detectortype (id,permissions,value)
    select ome_nextval('seq_detectortype'),-35,'EM-CCD' from dual;
insert into detectortype (id,permissions,value)
    select ome_nextval('seq_detectortype'),-35,'APD' from dual;
insert into detectortype (id,permissions,value)
    select ome_nextval('seq_detectortype'),-35,'CMOS' from dual;
insert into detectortype (id,permissions,value)
    select ome_nextval('seq_detectortype'),-35,'EBCCD' from dual;
insert into detectortype (id,permissions,value)
    select ome_nextval('seq_detectortype'),-35,'Other' from dual;
insert into detectortype (id,permissions,value)
    select ome_nextval('seq_detectortype'),-35,'Unknown' from dual;
insert into pulse (id,permissions,value)
    select ome_nextval('seq_pulse'),-35,'CW' from dual;
insert into pulse (id,permissions,value)
    select ome_nextval('seq_pulse'),-35,'Single' from dual;
insert into pulse (id,permissions,value)
    select ome_nextval('seq_pulse'),-35,'QSwitched' from dual;
insert into pulse (id,permissions,value)
    select ome_nextval('seq_pulse'),-35,'Repetitive' from dual;
insert into pulse (id,permissions,value)
    select ome_nextval('seq_pulse'),-35,'ModeLocked' from dual;
insert into pulse (id,permissions,value)
    select ome_nextval('seq_pulse'),-35,'Other' from dual;
insert into pulse (id,permissions,value)
    select ome_nextval('seq_pulse'),-35,'Unknown' from dual;
insert into microbeammanipulationtype (id,permissions,value)
    select ome_nextval('seq_microbeammanipulationtype'),-35,'FRAP' from dual;
insert into microbeammanipulationtype (id,permissions,value)
    select ome_nextval('seq_microbeammanipulationtype'),-35,'Photoablation' from dual;
insert into microbeammanipulationtype (id,permissions,value)
    select ome_nextval('seq_microbeammanipulationtype'),-35,'Photoactivation' from dual;
insert into microbeammanipulationtype (id,permissions,value)
    select ome_nextval('seq_microbeammanipulationtype'),-35,'Uncaging' from dual;
insert into microbeammanipulationtype (id,permissions,value)
    select ome_nextval('seq_microbeammanipulationtype'),-35,'OpticalTrapping' from dual;
insert into microbeammanipulationtype (id,permissions,value)
    select ome_nextval('seq_microbeammanipulationtype'),-35,'FLIP' from dual;
insert into microbeammanipulationtype (id,permissions,value)
    select ome_nextval('seq_microbeammanipulationtype'),-35,'InverseFRAP' from dual;
insert into microbeammanipulationtype (id,permissions,value)
    select ome_nextval('seq_microbeammanipulationtype'),-35,'Other' from dual;
insert into microbeammanipulationtype (id,permissions,value)
    select ome_nextval('seq_microbeammanipulationtype'),-35,'Unknown' from dual;
insert into medium (id,permissions,value)
    select ome_nextval('seq_medium'),-35,'Air' from dual;
insert into medium (id,permissions,value)
    select ome_nextval('seq_medium'),-35,'Oil' from dual;
insert into medium (id,permissions,value)
    select ome_nextval('seq_medium'),-35,'Water' from dual;
insert into medium (id,permissions,value)
    select ome_nextval('seq_medium'),-35,'Glycerol' from dual;
insert into medium (id,permissions,value)
    select ome_nextval('seq_medium'),-35,'Other' from dual;
insert into medium (id,permissions,value)
    select ome_nextval('seq_medium'),-35,'Unknown' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'Rhodamine6G' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'CoumarinC30' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'ArFl' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'ArCl' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'KrFl' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'KrCl' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'XeFl' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'XeCl' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'XeBr' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'GaAs' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'GaAlAs' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'EMinus' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'Cu' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'Ag' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'N' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'Ar' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'Kr' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'Xe' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'HeNe' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'HeCd' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'CO' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'CO2' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'H2O' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'HFl' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'NdGlass' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'NdYAG' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'ErGlass' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'ErYAG' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'HoYLF' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'HoYAG' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'Ruby' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'TiSapphire' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'Alexandrite' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'Other' from dual;
insert into lasermedium (id,permissions,value)
    select ome_nextval('seq_lasermedium'),-35,'Unknown' from dual;
insert into pixelstype (id,permissions,value)
    select ome_nextval('seq_pixelstype'),-35,'bit' from dual;
insert into pixelstype (id,permissions,value)
    select ome_nextval('seq_pixelstype'),-35,'int8' from dual;
insert into pixelstype (id,permissions,value)
    select ome_nextval('seq_pixelstype'),-35,'int16' from dual;
insert into pixelstype (id,permissions,value)
    select ome_nextval('seq_pixelstype'),-35,'int32' from dual;
insert into pixelstype (id,permissions,value)
    select ome_nextval('seq_pixelstype'),-35,'uint8' from dual;
insert into pixelstype (id,permissions,value)
    select ome_nextval('seq_pixelstype'),-35,'uint16' from dual;
insert into pixelstype (id,permissions,value)
    select ome_nextval('seq_pixelstype'),-35,'uint32' from dual;
insert into pixelstype (id,permissions,value)
    select ome_nextval('seq_pixelstype'),-35,'float' from dual;
insert into pixelstype (id,permissions,value)
    select ome_nextval('seq_pixelstype'),-35,'double' from dual;
insert into pixelstype (id,permissions,value)
    select ome_nextval('seq_pixelstype'),-35,'complex' from dual;
insert into pixelstype (id,permissions,value)
    select ome_nextval('seq_pixelstype'),-35,'double-complex' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'PNG' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/PNG' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'JPEG' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/JPEG' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'PGM' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/PGM' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Fits' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/Fits' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'GIF' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/GIF' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'BMP' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/BMP' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Dicom' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/Dicom' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'BioRad' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/BioRad' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'IPLab' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/IPLab' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Deltavision' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/Deltavision' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'MRC' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/MRC' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Gatan' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/Gatan' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Imaris' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/Imaris' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'OpenlabRaw' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/OpenlabRaw' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'OMEXML' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/OMEXML' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'LIF' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/LIF' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'AVI' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/AVI' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'QT' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/QT' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Pict' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/Pict' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'SDT' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/SDT' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'EPS' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/EPS' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Slidebook' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/Slidebook' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Alicona' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/Alicona' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'MNG' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/MNG' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'NRRD' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/NRRD' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Khoros' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/Khoros' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Visitech' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/Visitech' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'LIM' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/LIM' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'PSD' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/PSD' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'InCell' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/InCell' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'ICS' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/ICS' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'PerkinElmer' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/PerkinElmer' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'TCS' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/TCS' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'FV1000' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/FV1000' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'ZeissZVI' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/ZeissZVI' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'IPW' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/IPW' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'LegacyND2' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/LegacyND2' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'ND2' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/ND2' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'PCI' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/PCI' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'ImarisHDF' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/ImarisHDF' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Metamorph' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/Metamorph' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'ZeissLSM' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/ZeissLSM' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'SEQ' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/SEQ' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Gel' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/Gel' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'ImarisTiff' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/ImarisTiff' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Flex' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/Flex' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'SVS' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/SVS' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Leica' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/Leica' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Nikon' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/Nikon' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Fluoview' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/Fluoview' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Prairie' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/Prairie' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Micromanager' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/Micromanager' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'ImprovisionTiff' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/ImprovisionTiff' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'OMETiff' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/OMETiff' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'MetamorphTiff' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/MetamorphTiff' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Tiff' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/Tiff' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Openlab' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/Openlab' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'MIAS' from dual;
insert into format (id,permissions,value)
    select ome_nextval('seq_format'),-35,'Companion/MIAS' from dual;
insert into correction (id,permissions,value)
    select ome_nextval('seq_correction'),-35,'UV' from dual;
insert into correction (id,permissions,value)
    select ome_nextval('seq_correction'),-35,'PlanApo' from dual;
insert into correction (id,permissions,value)
    select ome_nextval('seq_correction'),-35,'PlanFluor' from dual;
insert into correction (id,permissions,value)
    select ome_nextval('seq_correction'),-35,'SuperFluor' from dual;
insert into correction (id,permissions,value)
    select ome_nextval('seq_correction'),-35,'VioletCorrected' from dual;
insert into correction (id,permissions,value)
    select ome_nextval('seq_correction'),-35,'Achro' from dual;
insert into correction (id,permissions,value)
    select ome_nextval('seq_correction'),-35,'Achromat' from dual;
insert into correction (id,permissions,value)
    select ome_nextval('seq_correction'),-35,'Fluor' from dual;
insert into correction (id,permissions,value)
    select ome_nextval('seq_correction'),-35,'Fl' from dual;
insert into correction (id,permissions,value)
    select ome_nextval('seq_correction'),-35,'Fluar' from dual;
insert into correction (id,permissions,value)
    select ome_nextval('seq_correction'),-35,'Neofluar' from dual;
insert into correction (id,permissions,value)
    select ome_nextval('seq_correction'),-35,'Fluotar' from dual;
insert into correction (id,permissions,value)
    select ome_nextval('seq_correction'),-35,'Apo' from dual;
insert into correction (id,permissions,value)
    select ome_nextval('seq_correction'),-35,'Other' from dual;
insert into correction (id,permissions,value)
    select ome_nextval('seq_correction'),-35,'Unknown' from dual;
insert into acquisitionmode (id,permissions,value)
    select ome_nextval('seq_acquisitionmode'),-35,'WideField' from dual;
insert into acquisitionmode (id,permissions,value)
    select ome_nextval('seq_acquisitionmode'),-35,'LaserScanningConfocalMicroscopy' from dual;
insert into acquisitionmode (id,permissions,value)
    select ome_nextval('seq_acquisitionmode'),-35,'SpinningDiskConfocal' from dual;
insert into acquisitionmode (id,permissions,value)
    select ome_nextval('seq_acquisitionmode'),-35,'SlitScanConfocal' from dual;
insert into acquisitionmode (id,permissions,value)
    select ome_nextval('seq_acquisitionmode'),-35,'MultiPhotonMicroscopy' from dual;
insert into acquisitionmode (id,permissions,value)
    select ome_nextval('seq_acquisitionmode'),-35,'StructuredIllumination' from dual;
insert into acquisitionmode (id,permissions,value)
    select ome_nextval('seq_acquisitionmode'),-35,'SingleMoleculeImaging' from dual;
insert into acquisitionmode (id,permissions,value)
    select ome_nextval('seq_acquisitionmode'),-35,'TotalInternalReflection' from dual;
insert into acquisitionmode (id,permissions,value)
    select ome_nextval('seq_acquisitionmode'),-35,'FluorescenceLifetime' from dual;
insert into acquisitionmode (id,permissions,value)
    select ome_nextval('seq_acquisitionmode'),-35,'SpectralImaging' from dual;
insert into acquisitionmode (id,permissions,value)
    select ome_nextval('seq_acquisitionmode'),-35,'FluorescenceCorrelationSpectroscopy' from dual;
insert into acquisitionmode (id,permissions,value)
    select ome_nextval('seq_acquisitionmode'),-35,'NearFieldScanningOpticalMicroscopy' from dual;
insert into acquisitionmode (id,permissions,value)
    select ome_nextval('seq_acquisitionmode'),-35,'SecondHarmonicGenerationImaging' from dual;
insert into acquisitionmode (id,permissions,value)
    select ome_nextval('seq_acquisitionmode'),-35,'PALM' from dual;
insert into acquisitionmode (id,permissions,value)
    select ome_nextval('seq_acquisitionmode'),-35,'STORM' from dual;
insert into acquisitionmode (id,permissions,value)
    select ome_nextval('seq_acquisitionmode'),-35,'STED' from dual;
insert into acquisitionmode (id,permissions,value)
    select ome_nextval('seq_acquisitionmode'),-35,'TIRF' from dual;
insert into acquisitionmode (id,permissions,value)
    select ome_nextval('seq_acquisitionmode'),-35,'FSM' from dual;
insert into acquisitionmode (id,permissions,value)
    select ome_nextval('seq_acquisitionmode'),-35,'LCM' from dual;
insert into acquisitionmode (id,permissions,value)
    select ome_nextval('seq_acquisitionmode'),-35,'Other' from dual;
insert into acquisitionmode (id,permissions,value)
    select ome_nextval('seq_acquisitionmode'),-35,'Unknown' from dual;
insert into jobstatus (id,permissions,value)
    select ome_nextval('seq_jobstatus'),-35,'Submitted' from dual;
insert into jobstatus (id,permissions,value)
    select ome_nextval('seq_jobstatus'),-35,'Resubmitted' from dual;
insert into jobstatus (id,permissions,value)
    select ome_nextval('seq_jobstatus'),-35,'Queued' from dual;
insert into jobstatus (id,permissions,value)
    select ome_nextval('seq_jobstatus'),-35,'Requeued' from dual;
insert into jobstatus (id,permissions,value)
    select ome_nextval('seq_jobstatus'),-35,'Running' from dual;
insert into jobstatus (id,permissions,value)
    select ome_nextval('seq_jobstatus'),-35,'Error' from dual;
insert into jobstatus (id,permissions,value)
    select ome_nextval('seq_jobstatus'),-35,'Waiting' from dual;
insert into jobstatus (id,permissions,value)
    select ome_nextval('seq_jobstatus'),-35,'Finished' from dual;
insert into jobstatus (id,permissions,value)
    select ome_nextval('seq_jobstatus'),-35,'Cancelled' from dual;
insert into contrastmethod (id,permissions,value)
    select ome_nextval('seq_contrastmethod'),-35,'Brightfield' from dual;
insert into contrastmethod (id,permissions,value)
    select ome_nextval('seq_contrastmethod'),-35,'Phase' from dual;
insert into contrastmethod (id,permissions,value)
    select ome_nextval('seq_contrastmethod'),-35,'DIC' from dual;
insert into contrastmethod (id,permissions,value)
    select ome_nextval('seq_contrastmethod'),-35,'HoffmanModulation' from dual;
insert into contrastmethod (id,permissions,value)
    select ome_nextval('seq_contrastmethod'),-35,'ObliqueIllumination' from dual;
insert into contrastmethod (id,permissions,value)
    select ome_nextval('seq_contrastmethod'),-35,'PolarizedLight' from dual;
insert into contrastmethod (id,permissions,value)
    select ome_nextval('seq_contrastmethod'),-35,'Darkfield' from dual;
insert into contrastmethod (id,permissions,value)
    select ome_nextval('seq_contrastmethod'),-35,'Fluorescence' from dual;
insert into contrastmethod (id,permissions,value)
    select ome_nextval('seq_contrastmethod'),-35,'Other' from dual;
insert into contrastmethod (id,permissions,value)
    select ome_nextval('seq_contrastmethod'),-35,'Unknown' from dual;
